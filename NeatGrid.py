...
class NeatGrid:
    ...
    WALLET_EXPOSURE_LIMIT_MIN = 0.05
    WALLET_EXPOSURE_LIMIT_MAX = 5.0
    ...
    AUTO_UNSTUCK_EMA_DIST_MIN = -0.1
    AUTO_UNSTUCK_EMA_DIST_MAX = 0.01
    ...
    AUTO_UNSTUCK_DELAY_MINUTES_MAX = 10000.0
