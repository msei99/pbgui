;(function () {
  ...
  function commonPanelMarkup() {
    return ''
      ...
      +     '<span id="results-count-label" class="results-count-label"></span>'
      +     '<details id="results-columns-picker" class="result-columns-picker">'
      +       '<summary id="results-columns-summary" class="act-btn">Columns</summary>'
      +       '<div class="result-columns-menu"><div id="results-columns-options" class="result-columns-options"></div>'
      +         '<div class="result-columns-actions">'
      +           '<button id="results-columns-defaults" class="act-btn" type="button">Defaults</button>'
      +           '<button id="results-columns-all" class="act-btn" type="button">All</button>'
      +           '<button id="results-columns-done" class="act-btn" type="button">Done</button>'
      +         '</div>'
      +       '</div>'
      +     '</details><span class="bt-toolbar-spacer"></span>'
