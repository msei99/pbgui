...
def pbdata_details():
    ...
    # (Removed legacy WS payload debug checkbox — payload debug can be enabled
    # via configuration or PBData flags. Keeping UI focused and minimal.)
    ...
    # Show PBData logfile (use new filtered viewer). Placed after the
    # fetch summary for better contextual relevance.
