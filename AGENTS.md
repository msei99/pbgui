...
This project is indexed by GitNexus as **pbgui** (19064 symbols, 58037 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
