...
| **PBAPIServer** | Runs the FastAPI backend (REST + WebSocket) that powers the VPS Monitor with live SSH connections |
...
5. **PBAPIServer** — enables persistent VPS connections and real-time monitor data (if used)
