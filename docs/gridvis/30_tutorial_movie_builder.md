...
Movie Builder creates a time-stepped animation of bot behavior.
...
> NOTE: This tutorial was moved to `pbgui/docs/strategy_explorer`. Please use the Strategy Explorer docs instead.
