...
**Scan all_results** ist deaktiviert, solange `all_results.bin` fehlt. Bei Vast.ai-Laeufen steht die gesamte Historie nach Abschluss der Optimierung und Download der finalen Ergebnisse zur Verfuegung. Der Hinweis erscheint beim Ueberfahren des deaktivierten Buttons; die Pareto-Front bleibt waehrend des Laufs nutzbar.
