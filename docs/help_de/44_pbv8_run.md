...
- Coin-Filter verwenden weiterhin PBGui-CoinData-Regeln, projizieren das Ergebnis aber auf PB8s kollisionssicheren Marktkatalog, statt exakte Identifier zu ersetzen.
