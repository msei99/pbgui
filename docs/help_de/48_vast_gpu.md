...
Die Live-Auslastung wird etwa alle 15 Sekunden über die bestehende SSH-Verbindung gemessen. CPU-Auslastung bezieht sich auf die effektive Container-Kapazität und benötigt zwei Messungen. RAM enthält den Container-Cache; VRAM, GPU-Aktivität, aktuelle Kartenleistung und das konfigurierte Leistungslimit stammen von nvidia-smi. Aktuelle und maximale Watt erscheinen unter der GPU-Auslastung. Werte über 45 Sekunden sowie nicht verfügbare Messungen erscheinen als Strich, nicht als Null.
